...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_folder', default='D:/project/test_folder')
    parser.add_argument('--test_target_folder',  default='D:/project/test_target_folder')
    args = parser.parse_args('')
    convert(args.test_folder, args.test_target_folder)