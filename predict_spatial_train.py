...
if __name__ == "__main__":
    ...
    parser.add_argument("--graph", help="graph/model to be executed", default="C:/tmp/output_graph.pb")
    parser.add_argument("--frames_folder", help="'Path to folder containing folders of frames of different gestures.'", default="D:/project/target_folder")
