...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_file_dump", help="file containing intermediate representation of gestures from inception model.",  default="C:/tmp/predicted-frames-final_result-test.pkl" )
    parser.add_argument("--model_file", help="Name of the model file to be used for prediction.", default="non_pool")
